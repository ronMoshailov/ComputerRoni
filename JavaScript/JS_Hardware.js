...
// Code that I didn't use in the end. //

// *************************************************************** //

// // Modals
//   for (var i = 1; i <= 10; i++) {
//     var modalId = "Case_0" + i;
//     var imageSrc = "../HTML/Images/Case_0" + i + ".jpg";
//     document.write(
...
//     for (var i = 1; i <= 10; i++) {
//       var modalId = "Motherboard_0" + i;
//       var imageSrc = "../HTML/Images/Motherboard_0" + i + ".jpg";
//       document.write(
//         '<div class="hiddenImageSize modal fade" id="' + modalId + '">' +
//         '  <div class="modal-dialog">' +
//         '    <div class="modal-content">' +
...
//     for (var i = 1; i <= 10; i++) {
//       var modalId = "Storage_0" + i;
//       var imageSrc = "../HTML/Images/Storage_0" + i + ".jpg";
//       document.write(
//         '<div class="hiddenImageSize modal fade" id="' + modalId + '">' +
//         '  <div class="modal-dialog">' +
//         '    <div class="modal-content">' +
